...
| --- | ---: | --- |
| DRAT generated Core | 4.2.0 / `40200` | CalcPad CE worksheet evaluation |
| Definitions | `20100` | Bundled with Core 4.2.0 |
| Stylesheet | `10900` | Bundled with Core 4.2.0 |
| DataWrapper | `303` | Bundled with Core 4.2.0 |
| Engineering Checks | `20000` | Bundled with Core 4.2.0 |
| Check Registry | `10100` | Bundled with Core 4.2.0 |
| Database | `10000` | Bundled with Core 4.2.0 |
| Validation | `20100` | Bundled with Core 4.2.0 |
| Calculation Status | `20000` | Bundled with Core 4.2.0 |
| Reporting | `20100` | Bundled with Core 4.2.0 |
| Review Summary | `10100` | Bundled with Core 4.2.0 |

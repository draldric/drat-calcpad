...
- Deterministic public-Core API audit that rejects undocumented, duplicated, or unexplained definition-only helpers and inventories implementation-only helpers.
